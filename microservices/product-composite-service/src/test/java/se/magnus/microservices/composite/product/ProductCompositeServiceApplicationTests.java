...
public class ProductCompositeServiceApplicationTests {
	...
	public void createCompositeProduct2(){
		ProductAggregate productAggregate = new ProductAggregate(1,
				"name ",
				1,
				singletonList(new RecommendationSummary(1,
						"name",1,"good"))
				,singletonList(new ReviewSummary(1,"name","subject","C"))
				,null);
		postAndVerifyProduct(productAggregate,OK);
	}

	@Test
	public void createCompositeProduct3(){
		ProductAggregate productAggregate = new ProductAggregate(1,
				"name ",
				1,
				singletonList(new RecommendationSummary(1,
				...
				,null);
		postAndVerifyProduct(productAggregate,OK);
		deleteAndVerifyProduct(productAggregate.getProductId(),OK);
	}


	public void postAndVerifyProduct(ProductAggregate compositeProduct,
